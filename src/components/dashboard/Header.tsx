...
const Header = ({ task }: Props) => {
  return (
    <div className="navbar bg-base-100 w-screen fixed z-0">
      <div className="flex w-screen">
        <div className="form-control flex static w-[40%] h-[54px]">
          <input
            type="text"
            placeholder="Search"
            className=" h-[54px] bg-slate-100 pl-8 rounded-[14px]"
          />
          <div className="text-black  absolute inset-y-0 left-[34%] flex items-center pl-12">
            <svg
        ...
        <div className="dropdown flex flex-end dropdown-end left-[25%]">
          <div className="flex items-center px-10">   <Bell/></div>
          ...
          >
            <li>
              <a className="justify-between">
                Profile
                <span className="badge">Some Badge</span>
              </a>
            </li>
            <li>
              <a>Settings</a>
